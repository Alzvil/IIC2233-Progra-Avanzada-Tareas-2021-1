...
class Entretenimiento(Local):
    ...
    def __init__(self, productos, nombre, aforo, trabajador):
        Local.__init__(self, productos, nombre, int(aforo), trabajador)
        self.categoria = "Entretenimiento"

    def cliente_ingresa(self, cliente):
        resultado = Local.cliente_ingresa(self, cliente)
        if resultado == True:
...
class Casino(Entretenimiento, Comida):
    ...
    def __init__(self, productos, nombre, aforo, trabajador):
        super().__init__(productos, nombre, int(aforo), trabajador)
...
class Supermercado(Comida, Tienda):
    ...
    def __init__(self, productos, nombre, aforo, trabajador):
        #intenté usar super() pero arrojaba el error de que le daba 6 y aceptaba 5 argumentos
